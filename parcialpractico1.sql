...
-- Tiempo de generación: 30-06-2026 a las 14:49:16
...
--
-- Base de datos: `parcialpractico1`
--
...
CREATE TABLE IF NOT EXISTS `inscriptores` (
  ...
  `firma_digital` text,
  `estado_integridad` enum('valido','corrupto') DEFAULT 'valido',
  PRIMARY KEY (`id`),
...
INSERT INTO `inscriptores` (`id`, `identidad`, `nombre`, `apellido`, `edad`, `sexo`, `pais_residencia_id`, `nacionalidad_id`, `correo`, `celular`, `observaciones`, `fecha_registro`, `firma_digital`, `estado_integridad`) VALUES
(1, '8-1025-781', 'Idianeth', 'Hanna', 20, 'Femenino', 1, 1, 'idianethjtmd@gmail.com', '68437366', 'ninguna', '2026-06-30 14:44:45', '', 'valido'),
(2, '8-990-782', 'Maria', 'Sanchez', 23, 'Femenino', 1, 1, 'idianethjtmd@gmail.com', '68437366', 'ninguna', '2026-06-30 14:45:53', '', 'valido');
